...
# Switches
set_property PACKAGE_PIN R2 [get_ports in_data[15]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[15]]

set_property PACKAGE_PIN T1 [get_ports in_data[14]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[14]]

set_property PACKAGE_PIN U1 [get_ports in_data[13]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[13]]

set_property PACKAGE_PIN W2 [get_ports in_data[12]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[12]]

set_property PACKAGE_PIN R3 [get_ports in_data[11]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[11]]

set_property PACKAGE_PIN T2 [get_ports in_data[10]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[10]]

set_property PACKAGE_PIN T3 [get_ports in_data[9]]
set_property IOSTANDARD LVCMOS33 [get_ports in_data[9]]

set_property PACKAGE_PIN V2 [get_ports in_data[8]]
...
#Push Button
set_property PACKAGE_PIN W19 [get_ports show_lat]
set_property IOSTANDARD LVCMOS33 [get_ports show_lat]

set_property PACKAGE_PIN T17 [get_ports show_long]
set_property IOSTANDARD LVCMOS33 [get_ports show_long]

set_property PACKAGE_PIN U18 [get_ports show_digit]
set_property IOSTANDARD LVCMOS33 [get_ports show_digit]
