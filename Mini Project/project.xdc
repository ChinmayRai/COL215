...
set_property IOSTANDARD LVCMOS33 [get_ports record_lat]

set_property PACKAGE_PIN T17 [get_ports record_long]
set_property IOSTANDARD LVCMOS33 [get_ports record_long]

set_property PACKAGE_PIN T18 [get_ports reset]
set_property IOSTANDARD LVCMOS33 [get_ports reset]

set_property PACKAGE_PIN U17 [get_ports state_change]
set_property IOSTANDARD LVCMOS33 [get_ports state_change]

set_property PACKAGE_PIN U18 [get_ports push_query]
set_property IOSTANDARD LVCMOS33 [get_ports push_query]
...
set_property IOSTANDARD LVCMOS33 [get_ports update_state_indicator]

set_property PACKAGE_PIN P1 [get_ports query_state_indicator]
set_property IOSTANDARD LVCMOS33 [get_ports query_state_indicator]

set_property PACKAGE_PIN N3 [get_ports reset_state_indicator]
set_property IOSTANDARD LVCMOS33 [get_ports reset_state_indicator]
